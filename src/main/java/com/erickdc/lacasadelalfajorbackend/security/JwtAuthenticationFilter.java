package com.erickdc.lacasadelalfajorbackend.security;

import com.erickdc.lacasadelalfajorbackend.service.JwtService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (header != null && header.startsWith("Bearer ")) {
            try {
                ...
                // token inválido o vencido: sigue sin autenticar
            }
        }
